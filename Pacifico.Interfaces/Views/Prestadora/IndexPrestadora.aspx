...
<table width="100%">
    <tr>
        <td><%: Html.ActionLink("Buscar Prestadora", "SearchPrestadora", "Prestadora", routeValues: null, htmlAttributes: new {@class="btn"})%></td>
        <td align="right">&nbsp;</td>
    </tr>
</table>
...
<% foreach (var item in Model) {
    ...
    <tr>
        ...
        <td><%: activo %></td>
        <td><i class="icon-file"></i> <%: Html.ActionLink("Visualizar", "DetailsPrestadora","Prestadora", new { id=item.Co_Prestadora }, htmlAttributes: null) %></td>
        <td><i class="icon-edit"></i> <%: Html.ActionLink("Iniciar Evaluacion", "Index","EvaluacionPrestadora", new { codigoPrestadora = item.Co_Prestadora }, htmlAttributes: null)%></td>
    </tr>
<% } %>
</table>
...
<table width="100%">
    <tr>
        <td>
            ...
            <%: Html.PagedListPager(Model,page => Url.Action("IndexPrestadora", new {razon,ruc,fechaIni,fechaFin,page,pageSize=Model.PageSize}), new PagedListRenderOptions { LinkToFirstPageFormat = "<<", LinkToPreviousPageFormat = "<", LinkToNextPageFormat = ">", LinkToLastPageFormat = ">>", MaximumPageNumbersToDisplay=3 }) %>
        </td>
        <td align="right">
