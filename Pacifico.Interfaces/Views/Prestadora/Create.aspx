    ...
    <table width="100%">
        <tr>
            ...
            <td>
                ...
                &nbsp;
                <%: Html.ActionLink("Cancelar", "Index", "Prestadora", routeValues: null, htmlAttributes: new {@class="btn", onclick = "return confirm('¿Desea salir de Registrar Prestadora?')" })%>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
