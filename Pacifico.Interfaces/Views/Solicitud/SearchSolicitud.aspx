...
<table width="100%">
        ...
        <tr>
            ...
            <td colspan="7" align="center">
                ...
                &nbsp;
                <%: Html.ActionLink("Cancelar", "IndexSolicitud", "Solicitud", routeValues: null, htmlAttributes: new {@class="btn", onclick = "return confirm('¿Desea salir de Buscar Solicitud?')" })%>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
