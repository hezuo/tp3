...
<table width="100%">
    <tr>
        <td><%: Html.ActionLink("Buscar Solicitud", "SearchSolicitud2", "Solicitud", routeValues: null, htmlAttributes: new {@class="btn"})%></td>
        <td align="right">&nbsp;</td>
    </tr>
</table>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td><%: Html.DisplayFor(modelItem => item.Nu_Folio) %></td>
        <td><%: Html.DisplayFor(modelItem => item.ESTADO_SOLICITUD.No_Estado) %></td>
        <td><i class="icon-edit"></i><%: Html.ActionLink("Editar", "EditSolicitud2", "Solicitud", new { id = item.Co_Solicitud },htmlAttributes: null)%></td>
        <td><i class="icon-edit"></i><%: Html.ActionLink("Iniciar Negociacion", "SelectSede", "NegociacionServicio", new { codigoSolicitud = item.Co_Solicitud, codigoPrestadora = item.Co_Prestadora }, htmlAttributes: null)%></td>
    </tr>
<% } %>
...
<table width="100%">
    <tr>
        <td>
            ...
            <%: Html.PagedListPager(Model,page => Url.Action("IndexSolicitud2", new {razon,ruc,fechaIni,fechaFin,usuario,estado,page,pageSize=Model.PageSize}), new PagedListRenderOptions { LinkToFirstPageFormat = "<<", LinkToPreviousPageFormat = "<", LinkToNextPageFormat = ">", LinkToLastPageFormat = ">>", MaximumPageNumbersToDisplay=3 }) %>
        </td>
        <td align="right">
