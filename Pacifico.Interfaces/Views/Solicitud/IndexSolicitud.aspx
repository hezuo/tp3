...
<table width="100%">
    <tr>
        <td><%: Html.ActionLink("Buscar Solicitud", "SearchSolicitud", "Solicitud", routeValues: null, htmlAttributes: new {@class="btn"})%></td>
        <td align="right">&nbsp;</td>
    </tr>
</table>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td><i class="icon-edit"></i><%: Html.ActionLink("Editar", "EditSolicitud", "Solicitud", new { id = item.Co_Solicitud },htmlAttributes: null)%></td>
        <td><i class="icon-edit"></i><%: Html.ActionLink("Iniciar Evaluacion", "SelectSede", "EvaluacionServicio", new { codigoSolicitud = item.Co_Solicitud, codigoPrestadora = item.Co_Prestadora }, htmlAttributes: null)%></td>
    </tr>
<% } %>
...
<table width="100%">
    <tr>
        <td>
            ...
            <%: Html.PagedListPager(Model,page => Url.Action("IndexSolicitud", new {razon,ruc,fechaIni,fechaFin,usuario,estado,page,pageSize=Model.PageSize}), new PagedListRenderOptions { LinkToFirstPageFormat = "<<", LinkToPreviousPageFormat = "<", LinkToNextPageFormat = ">", LinkToLastPageFormat = ">>", MaximumPageNumbersToDisplay=3 }) %>
        </td>
        <td align="right">
