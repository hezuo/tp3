...
<% using (Html.BeginForm()) { %>
    ...
    <table width="100%">
        ...
        <tr>
            <td>&nbsp;</td>
            <td><label for="Tx_EvaluacionServicios">Resumen de Evaluacion</label></td>
            <td><label>:</label></td>
            <td><%: Html.TextAreaFor(model => model.Tx_EvaluacionServicios) %></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
    ...
    <table width="100%">
        <tr>
            ...
            &nbsp;
            <%: Html.ActionLink("Cancelar", "IndexSolicitud", "Solicitud", routeValues: null, htmlAttributes: new {@class="btn", onclick = "return confirm('¿Desea salir de Modificar Solicitud?')" })%>
            <td align="right">
            </td><td>&nbsp;</td>
        </tr>
    </table>
