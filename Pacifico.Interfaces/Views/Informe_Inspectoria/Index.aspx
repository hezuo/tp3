<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<Pacifico.DataAccess.INFORME_INSPECTORIA>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Lista Informe Inspectoria</h2>
<label id="lblmsg" style="<%: ViewBag.css %>">
    ...
    <tr>
        <td>
            ...
            <%: Html.ActionLink("Crear Nuevo Informe Inspectoria", "Create", new { id = 0, ac = 0 }, new { @class="btn"})%>
...
<% foreach (var item in Model) { %>
    <tr>
        <td>
            <%: Html.DisplayFor(modelItem => item.Co_NumInfInspect)%>
        </td>
        <td>
