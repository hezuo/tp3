...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td><i class="icon-file"></i> <%: Html.ActionLink("Servicios", "Index","NegociacionServicio", new { codigoSolicitud = ViewData["CoSolicitud"], codigoPrestadora = ViewData["CoPrestadora"], codigoSede=item.Co_Sede }, htmlAttributes: null) %></td>
    </tr>
<% } %>
</table>
...
<table width="100%">
    <tr>
        <td><%: Html.ActionLink("Terminar", "IndexSolicitud2", "Solicitud", routeValues: null, htmlAttributes: new {@class="btn", onclick = "return confirm('¿Desea terminar la negociacion de servicio?')" })%>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
</table>
