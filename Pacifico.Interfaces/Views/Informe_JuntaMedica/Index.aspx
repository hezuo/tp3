<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<Pacifico.DataAccess.INFORME_JUNTA_MEDICA>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%">
        <tr>
            <td>
                ...
                <%: Html.ActionLink("Crear Nuevo Informe junta Medica", "Create", new { id = 0, ac = 0 }, new { @class="btn"})%>
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td>
                <%: Html.DisplayFor(modelItem => item.Co_NumInfJuntaMedica)%>
            </td>
            <td>
