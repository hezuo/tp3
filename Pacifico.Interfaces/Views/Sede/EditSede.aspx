    ...
    <table width="100%">
        <tr>
            ...
            <td>
                ...
                &nbsp;
                <%: Html.ActionLink("Cancelar", "SelectSede", "EvaluacionServicio",  new { codigoSolicitud = ViewData["co_Solicitud"], codigoPrestadora = ViewData["Co_Prestadora"] }, htmlAttributes: new {@class="btn", onclick = "return confirm('¿Desea salir de Modificar Sede?')" })%>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
