        ...
        $.post(
            ...
            function (jsonResult) {
                if (!jsonResult.success) {
                    ...
                    console.log(jsonResult.Co_Expediente);
                    alert("Se grabo el Expediente");
                    InsertarPOliza();
                }
            }
         )
        ...
        $.post(
            ...
            function (jsonResult) {
                if (!jsonResult.success)
                    ...
                    $("#msgError").text("");
                    alert("Se actualizo el Expediente");
                    InsertarPOliza();
                }
            }
        )
